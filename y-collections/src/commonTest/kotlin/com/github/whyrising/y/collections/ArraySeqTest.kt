...
import com.github.whyrising.y.collections.ArraySeq.BooleanArraySeq
import com.github.whyrising.y.collections.ArraySeq.ByteArraySeq
import com.github.whyrising.y.collections.ArraySeq.CharArraySeq
import com.github.whyrising.y.collections.ArraySeq.DoubleArraySeq
import com.github.whyrising.y.collections.ArraySeq.FloatArraySeq
import com.github.whyrising.y.collections.ArraySeq.IntArraySeq
import com.github.whyrising.y.collections.ArraySeq.LongArraySeq
import com.github.whyrising.y.collections.ArraySeq.ShortArraySeq
...
class ArraySeqTest {
    ...
    @Test
    fun `first() should return element at i in array`() {
    ...
    @Test
    fun `first() should throw NoSuchElementException when array is empty`() {
    ...
    @Test
    fun `rest() should a new ArraySeq with same array and incremented i`() {
        val array = arrayOf(54, 5, 3, 98)
        val i = 0
    ...
    @Test
    fun `rest() should return Empty seq when array is empty`() {
...
class ShortArraySeqTest {
    ...
    fun `indexOf(element)`() {
        ...
        ShortArraySeq(shortArrayOf(15, 2, 5), 0).indexOf(52) shouldBeExactly -1

        ShortArraySeq(shortArrayOf(15, 2, 5), 0).indexOf(2) shouldBeExactly 1
    ...
    fun `lastIndexOf(element)`() {
        ...
        ShortArraySeq(shortArrayOf(5, 5, 3), 0).lastIndexOf(3) shouldBeExactly 2

        (ShortArraySeq(shortArrayOf(5, 3, 3), 0).rest() as ShortArraySeq)
            .lastIndexOf(3) shouldBeExactly 1

        ShortArraySeq(shortArrayOf(5, 5, 3), 0).lastIndexOf(5) shouldBeExactly 1
...
class IntArraySeqTest {
    ...
    fun `lastIndexOf(element)`() {
        ...
        IntArraySeq(intArrayOf(5, 5, 3), 0).lastIndexOf(55) shouldBeExactly -1
    }
}
...
class FloatArraySeqTest {
    ...
    fun `rest() should return Empty seq when array is empty`() {
        ...
        restSeq shouldBeSameInstanceAs Empty
        FloatArraySeq(floatArrayOf(1F), 0).rest() shouldBeSameInstanceAs Empty
    }
    ...
    fun `count should return array size minus index`() {
        ...
        FloatArraySeq(floatArrayOf(54F, 5F), 0).rest().count shouldBeExactly 1
    }
    ...
    fun `indexOf(element)`() {
        ...
        (FloatArraySeq(floatArrayOf(15F, 2F, 5F), 0).rest() as FloatArraySeq)
    ...
    fun `lastIndexOf(element)`() {
        ...
        (FloatArraySeq(floatArrayOf(5F, 5F, 5F, 3F), 0).rest() as FloatArraySeq)
            .lastIndexOf(5F) shouldBeExactly 1
...
class DoubleArraySeqTest {
    ...
    fun `count should return array size minus index`() {
        ...
        DoubleArraySeq(doubleArrayOf(1.0, 2.0, 3.0), 0).count shouldBeExactly 3
    ...
    @Test
    fun `lastIndexOf(element)`() {
        DoubleArraySeq(doubleArrayOf(), 0).lastIndexOf(12.0) shouldBeExactly -1
...
class LongArraySeqTest {
    ...
    fun `indexOf(element)`() {
        ...
        LongArraySeq(longArrayOf(15, 2, 5), 0).indexOf(52) shouldBeExactly -1
    ...
    fun `lastIndexOf(element)`() {
        ...
        LongArraySeq(longArrayOf(5, 5, 3), 0).lastIndexOf(3) shouldBeExactly 2

        (LongArraySeq(longArrayOf(5, 3, 3), 0).rest() as LongArraySeq)
            .lastIndexOf(3) shouldBeExactly 1

        LongArraySeq(longArrayOf(5, 5, 3), 0).lastIndexOf(5) shouldBeExactly 1

        (LongArraySeq(longArrayOf(5, 5, 5, 3), 0).rest() as LongArraySeq)
            .lastIndexOf(5) shouldBeExactly 1

        LongArraySeq(longArrayOf(5, 5, 3), 0).lastIndexOf(55) shouldBeExactly -1
    }
}
...
class ByteArraySeqTest {
    ...
    fun `indexOf(element)`() {
        ...
        ByteArraySeq(byteArrayOf(15, 2, 5), 0).indexOf(52) shouldBeExactly -1
    ...
    fun `lastIndexOf(element)`() {
        ...
        ByteArraySeq(byteArrayOf(5, 5, 3), 0).lastIndexOf(3) shouldBeExactly 2

        (ByteArraySeq(byteArrayOf(5, 3, 3), 0).rest() as ByteArraySeq)
            .lastIndexOf(3) shouldBeExactly 1

        ByteArraySeq(byteArrayOf(5, 5, 3), 0).lastIndexOf(5) shouldBeExactly 1

        (ByteArraySeq(byteArrayOf(5, 5, 5, 3), 0).rest() as ByteArraySeq)
            .lastIndexOf(5) shouldBeExactly 1

        ByteArraySeq(byteArrayOf(5, 5, 3), 0).lastIndexOf(55) shouldBeExactly -1
    }
}
...
class CharArraySeqTest {
    ...
    fun `count should return array size minus index`() {
        ...
        CharArraySeq(charArrayOf('4', '5'), 0).rest().count shouldBeExactly 1
    }
...
class BooleanArraySeqTest {
    ...
    @Test
    fun `rest() should return Empty seq when array is empty`() {
        BooleanArraySeq(booleanArrayOf(), 0).rest() shouldBeSameInstanceAs Empty
    ...
    fun `count should return array size minus index`() {
        ...
        BooleanArraySeq(booleanArrayOf(true), 0).rest().count shouldBeExactly 0
    ...
    @Test
    fun `indexOf(element)`() {
        BooleanArraySeq(booleanArrayOf(), 0).indexOf(true) shouldBeExactly -1
