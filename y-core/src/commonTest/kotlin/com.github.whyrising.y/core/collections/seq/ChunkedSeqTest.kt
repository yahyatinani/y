...
class ChunkedSeqTest : FreeSpec({
  "ctor" {
    val chunk1 =
      com.github.whyrising.y.core.collections.ArrayChunk(arrayOf(1, 2, 3))
    val chunk2 =
      com.github.whyrising.y.core.collections.ArrayChunk(arrayOf(4, 5, 6))
  ...
  "restChunks()" - {
    "when there is any, it should return them" {
      val chunk1 = com.github.whyrising.y.core.collections.ArrayChunk(
        arrayOf(
          1,
          2,
          3
    ...
    "when there is none, it should return the Empty seq" {
      val chunk = com.github.whyrising.y.core.collections.ArrayChunk(
        arrayOf(
          1,
          2,
          3
  ...
  "rest()" - {
    ...
    "when firstChunk.count <= 1, it should call restChunks()" {
      val chunk1 =
        com.github.whyrising.y.core.collections.ArrayChunk(arrayOf(1))
      val chunk2 =
        com.github.whyrising.y.core.collections.ArrayChunk(arrayOf(2))
      val seq = ChunkedSeq(chunk2)
      val chunkedSeq = ChunkedSeq(chunk1, seq)
