...
import com.github.whyrising.y.core.collections.Edit
...
import com.github.whyrising.y.core.collections.PersistentHashMap.BitMapIndexedNode.BMIN
import com.github.whyrising.y.core.collections.PersistentHashMap.BitMapIndexedNode.EmptyBitMapIndexedNode
import com.github.whyrising.y.core.collections.PersistentHashMap.HashCollisionNode
import com.github.whyrising.y.core.collections.PersistentHashMap.Node
...
class BitMapIndexedNodeTest : FreeSpec({
  ...
  "mergeTwoKeyValuePairs()/pairToSubNode()/subNode()" - {
    """when currentKeyMask < newKeyMask, return a node containing both
      ...
      val currentNode = BMIN<String, Int>(edit, 0, 5, emptyArray()).assoc(
        edit,
        shift,
        currentHash,
        currentKey,
    ...
    "when newKeyMask = currentKeyMask, it should subNode again" {
      ...
      val currentHash = hasheq(currentKey)
      val currentNode = BMIN<String, Int>(edit, 0, 0, emptyArray()).assoc(
        edit,
        shift,
        currentHash,
        currentKey,
  ...
  "nodeSeq()" - {
    ...
    "when datamap == 0" - {
      "when node is empty, it should return an empty seq" {
        ...
        nodeSeq shouldBeSameInstanceAs Empty
        nodeSeq.rest() shouldBeSameInstanceAs Empty
